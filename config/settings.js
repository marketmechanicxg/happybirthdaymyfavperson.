...
const WEBSITE_PIN = "070726";              // ← GANTI PIN

/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   2. NAMA PENERIMA
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Nama yang muncul di halaman utama (hero).                      */
const RECIPIENT_NAME = "Syarful Fajri";           // ← GANTI NAMA
...
const MUSIC_TRACKS = [
  {
    title:  "ABOUTYOU",             // ← GANTI JUDUL LAGU
    artist: "THE1975",                   // ← GANTI NAMA ARTIS
...
const LETTER_PARAGRAPHS = [
  "ucapan ini sebenarnya udah aku siapin dari jauh-jauh hari, hehe. niatnya mau ngirim pas jam 00.00 biar jadi orang pertama yang ngucapin, eh malah kelupaan. maaf yaaa. 🤏🏻 mungkin ini terdengar agak lucu, but this is my love language. aku cuma pengen kamu tau kalau aku bener-bener nunggu hari spesial kamu dan ga mau ngelewatin momen ini begitu aja.",
  "happy birthday, my favorite person. 🤍 semoga di umur yang baru ini kamu selalu diberi kesehatan, kebahagiaan, kesuksesan, dan semua hal baik yang selama ini kamu harapin. terima kasih ya karena udah jadi seseorang yang selalu bisa bikin aku ngerasa nyaman. kehadiran kamu bener-bener berarti buat aku, lebih dari yang mungkin pernah aku ungkapin.",
  "sekali lagi, selamat ulang tahun untuk laki-laki favoritku. semoga aku masih bisa jadi salah satu alasan di balik senyum kamu, dan semoga kamu tetap jadi laki-laki baik dengan hati yang hangat dan tulus, seperti yang selalu aku kenal. i hope the world is always kind to you, because you deserve nothing less than that.",
  "dan kalau suatu hari nanti waktu membawa kita ke jalan yang berbeda, aku tetap akan bersyukur karena pernah dipertemukan sama seseorang sebaik kamu. semoga semesta selalu menjaga setiap langkah kamu, di mana pun dan dengan siapa pun nanti kamu melangkah. please stay healthy, stay happy, and never stop being the amazing person you are. happy birthday, once again. 🤍",
];
...
const WHATSAPP_NUMBER = "62895415215871";   // ← GANTI NOMOR WA YANG ORDER
